...
import com.example.drcreditdev.login.otpVerificationUI.Otp_verification_Activity
import com.example.drcreditdev.services.ApiClientReqOTP
import kotlinx.android.synthetic.main.activity_user_number.*

class UserNumber_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.proceed.observe(this){
            if(it == true )
            {
                this@UserNumber_Activity.binding.btnVerify.isEnabled= true
                this@UserNumber_Activity.binding.btnVerify.backgroundTintList= ColorStateList.valueOf(
                    ResourcesCompat.getColor(resources,
                        R.color.button, theme))
                this@UserNumber_Activity.binding.btnVerify.setTextColor(Color.parseColor("#FFFFFF"))
            }
            else
            {
                this@UserNumber_Activity.binding.btnVerify.isEnabled= false
                this@UserNumber_Activity.binding.btnVerify.backgroundTintList= ColorStateList.valueOf(
                    ResourcesCompat.getColor(resources,
                        R.color.disable, theme))
                this@UserNumber_Activity.binding.btnVerify.setTextColor(Color.parseColor("#8897A2"))
            }
        }
    ...
    private fun OtpPage() {
        ...
        viewModel.repoResponse.observe(this,{
            if(it==1) {
                ...
                var intent = Intent(applicationContext, Otp_verification_Activity::class.java)
            ...
            else if(it==0)
            {
                ...
                Toast.makeText(this@UserNumber_Activity,"Unable to send otp", Toast.LENGTH_SHORT).show()
    ...
    private val textWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
            ...
            this@UserNumber_Activity.binding.linearLayout.setBackgroundResource(R.drawable.number_bg_on_click)
