...
import com.example.drcreditdev.creditCardUI.refreshPageUI.RefreshPage_Activity
import com.example.drcreditdev.creditCardUI.userDetailPageUI.User_details_Activity
...
class Otp_verification_Activity : AppCompatActivity() {
  ...
  //      var textView : TextView = findViewById(R.id.textView2)
    ...
    private fun changePage() {
        ...
        viewModel.intentInt.observe(this,{
            if(it == 0)
            {
                  ...
                  var intent = Intent(applicationContext, User_details_Activity::class.java)
                  startActivity(intent)
                  finish()
            }
            else if(it == 1)
            {
                var intent = Intent(applicationContext, RefreshPage_Activity::class.java)
                startActivity(intent)
                finish()
    ...
    fun startTimeCounter(view: Otp_verification_Activity) {
        var counter = 30
