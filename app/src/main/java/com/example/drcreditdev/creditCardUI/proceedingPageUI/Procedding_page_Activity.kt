...
import com.example.drcreditdev.creditCardUI.error.Error_page_Activity
import com.example.drcreditdev.databinding.ActivityProceddingPageBinding

class Procedding_page_Activity : AppCompatActivity() {
    ...
    private fun getCreditScore() {
        ...
        {
            var intent = Intent(applicationContext, Error_page_Activity::class.java)
        ...
        {
            var intent =
                Intent(applicationContext, Credit_home_page_Activity::class.java)
